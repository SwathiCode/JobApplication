        ...
        <nav className="navbar navbar-expand-lg navbar-light">
          <Link to="/" className="navbar-brand">
            <svg
              ...
              viewBox="0 0 16 16"
            >
              <path d="M5.68 5.792L7.345 7.75 5.681 9.708a2.75 2.75 0 1 1 0-3.916ZM8 6.978L6.416 5.113l-.014-.015a3.75 3.75 0 1 0 0 5.304l.014-.015L8 8.522l1.584 1.865.014.015a3.75 3.75 0 1 0 0-5.304l-.014.015zm.656.772L10.319 5.792a2.75 2.75 0 1 1 0 3.916z" />
            </svg>
          </Link>
            ...
            <ul className="navbar-nav">
              ...
              {isLoggedIn ? (
                <>
                  ...
                  <li className="nav-item">
                  <Link to="/" className="nav-link" onClick={clickLogout}>Logout</Link>
                  </li>
                </>
              ) : (
                <>
              ...
              <li className="nav-item">
                <Link to="/ProjectRequirement" className="nav-link">Project Requirement</Link>
              </li>
              <li className="nav-item">
...
{isLoggedIn ? (
    ...
    <li className="nav-item">
                    <button onClick={clickLogout} className="nav-link btn btn-link p-0" style={{ textDecoration: 'none' }}></button>
                  </li>
                </>
              )}
